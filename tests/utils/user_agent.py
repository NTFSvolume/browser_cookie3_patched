...
class HTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def __handle_get_request(self) -> None:
...
class UAGetter:
    ...
    def __init__(self, binary_path: str, headless_mode: str = HEADLESS_DEFAULT, timeout: int = DEFAULT_TIMEOUT):
        self.__set_server()
    ...
    def get(self) -> str:
        ...
        return _ua_list[0] if _ua_list else None  # type: ignore
