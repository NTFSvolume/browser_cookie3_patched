...
class ChromeDriverVersion:
    ...
    def __get_chrome_major_version(self) -> str:
        try:
            ...
            raise ValueError("Not a Chrome user agent string") from None
...
def get_driver_version_from_chromium_based_binary(binary_location: str) -> str:
    ...
    ua_string = UAGetter(binary_location, UAGetter.HEADLESS_NEW).get()
    return ChromeDriverVersion(ua_string).get()
